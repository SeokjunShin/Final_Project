...
export const NotificationsPage = () => {
  ...
  const filteredNotifications = tab === 0
    ? notifications
    : tab === 1
    ? notifications.filter((n: NotificationItem) => isUnread(n))
  ...
  const unreadCount = notifications.filter((n: NotificationItem) => isUnread(n)).length;
              ...
              return (
                <Box
                  ...
                  sx={{
                    ...
                    cursor: 'pointer',
                    bgcolor: (notification.isRead ?? notification.read) ? '#fff' : '#fffbfb',
