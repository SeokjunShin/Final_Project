...
public class ApprovalService {
    ...
    private ApprovalResponse toResponse(Approval approval) {
        return ApprovalResponse.builder()
                ...
                .merchantName(approval.getMerchant() != null ? approval.getMerchant().getMerchantName() : null)
                .categoryName(approval.getMerchant() != null ? approval.getMerchant().getCategoryName() : null)
