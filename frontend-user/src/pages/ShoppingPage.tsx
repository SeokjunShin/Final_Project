...
const coupons: Coupon[] = [
    { id: 1, name: 'GS25 모바일 상품권 5천원', brand: 'GS25', category: 'convenience', points: 5000 * DISCOUNT_RATE, originalPrice: 5000, image: '/images/products/gs25.jfif', badge: '인기', description: 'GS25 전 매장에서 사용 가능한 모바일 상품권입니다.' },
    { id: 2, name: 'CU 모바일 상품권 1만원', brand: 'CU', category: 'convenience', points: 10000 * DISCOUNT_RATE, originalPrice: 10000, image: '/images/products/cu.webp', description: 'CU 전 매장에서 사용 가능한 모바일 상품권입니다.' },
    { id: 3, name: '이마트24 모바일 상품권 5천원', brand: '이마트24', category: 'convenience', points: 5000 * DISCOUNT_RATE, originalPrice: 5000, image: '/images/products/emart.jfif', description: '이마트24 전 매장에서 사용 가능한 모바일 상품권입니다.' },
    { id: 4, name: '스타벅스 아메리카노 T', brand: '스타벅스', category: 'cafe', points: 4500 * DISCOUNT_RATE, originalPrice: 4500, image: '/images/products/starbucks.png', badge: 'BEST', description: '스타벅스 전 매장에서 아메리카노 톨 사이즈 1잔으로 교환할 수 있습니다.' },
    { id: 5, name: '투썸플레이스 아이스 아메리카노 R', brand: '투썸플레이스', category: 'cafe', points: 4300 * DISCOUNT_RATE, originalPrice: 4300, image: '/images/products/twosome.png', description: '투썸플레이스 전 매장에서 아이스 아메리카노 레귤러 1잔으로 교환할 수 있습니다.' },
    { id: 6, name: '메가MGC커피 아메리카노 L', brand: '메가커피', category: 'cafe', points: 2000 * DISCOUNT_RATE, originalPrice: 2000, image: '/images/products/mega.png', badge: '추천', description: '메가커피 전 매장에서 아메리카노 라지 1잔으로 교환할 수 있습니다.' },
    { id: 7, name: 'BBQ 황금올리브 치킨 교환권', brand: 'BBQ', category: 'food', points: 22000 * DISCOUNT_RATE, originalPrice: 22000, image: '/images/products/bbq.png', description: 'BBQ 전 매장에서 황금올리브 치킨으로 교환할 수 있습니다.' },
    { id: 8, name: '맥도날드 빅맥세트 교환권', brand: '맥도날드', category: 'food', points: 7500 * DISCOUNT_RATE, originalPrice: 7500, image: '/images/products/mcdonalds.png', description: '맥도날드 전 매장에서 빅맥 세트로 교환할 수 있습니다.' },
    { id: 9, name: '신세계백화점 상품권 5만원', brand: '신세계', category: 'department', points: 50000 * DISCOUNT_RATE, originalPrice: 50000, image: '/images/products/sinse.jfif', badge: '프리미엄', description: '신세계백화점 전 점에서 사용 가능한 모바일 상품권입니다.' },
    { id: 10, name: '올리브영 모바일 상품권 1만원', brand: '올리브영', category: 'department', points: 10000 * DISCOUNT_RATE, originalPrice: 10000, image: '/images/products/olive.jpg', badge: '인기', description: '올리브영 전 매장에서 사용 가능한 모바일 상품권입니다.' },
    { id: 11, name: '현대백화점 상품권 3만원', brand: '현대백화점', category: 'department', points: 30000 * DISCOUNT_RATE, originalPrice: 30000, image: '/images/products/hyundai.avif', description: '현대백화점 전 점에서 사용 가능한 모바일 상품권입니다.' },
    { id: 12, name: 'S-OIL 주유 상품권 3만원', brand: 'S-OIL', category: 'gas', points: 30000 * DISCOUNT_RATE, originalPrice: 30000, image: '/images/products/soil.png', description: 'S-OIL 전 주유소에서 사용 가능한 모바일 주유 상품권입니다.' },
    { id: 13, name: 'GS칼텍스 주유 상품권 5만원', brand: 'GS칼텍스', category: 'gas', points: 50000 * DISCOUNT_RATE, originalPrice: 50000, image: '/images/products/gscal.jpg', description: 'GS칼텍스 전 주유소에서 사용 가능한 모바일 주유 상품권입니다.' },
    { id: 14, name: '해피머니 온라인 상품권 1만원', brand: '해피머니', category: 'voucher', points: 10000 * DISCOUNT_RATE, originalPrice: 10000, image: '/images/products/happy.jpg', description: '온라인 가맹점에서 사용 가능한 모바일 상품권입니다.' },
    { id: 15, name: '문화상품권 모바일 5천원', brand: '문화상품권', category: 'voucher', points: 5000 * DISCOUNT_RATE, originalPrice: 5000, image: '/images/products/culture.jfif', badge: '추천', description: '도서, 공연, 영화 등 문화생활에 사용 가능한 모바일 상품권입니다.' },
];
